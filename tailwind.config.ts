...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "glow-pulse": {
          ...
          "50%": { 
            ...
            borderColor: "hsl(var(--cyber-cyan) / 0.8)"
          },
        },
        "float": {
      ...
      backgroundImage: {
        "cyber-gradient": "linear-gradient(135deg, hsl(var(--background)) 0%, hsl(var(--cyber-dark)) 100%)",
        "glow-radial": "radial-gradient(ellipse at center, hsl(var(--cyber-cyan) / 0.1) 0%, transparent 70%)",
      },
    },
  },
