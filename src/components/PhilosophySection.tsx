      ...
      <div className="container relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black tracking-tighter-custom leading-[1.1] mb-6">
              I TRY TO MAKE
              <br />
          ...
          >
            {philosophyStats.map((stat, index) => (
              ...
              >
                <div className="text-3xl md:text-4xl lg:text-5xl font-bold text-primary mb-2 font-mono">
                  {stat.value}
                </div>
